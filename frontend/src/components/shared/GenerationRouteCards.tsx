...
const ROUTE_FRAME_STYLE: CSSProperties = {
  background: "linear-gradient(180deg, light-dark(oklch(0.995 0.004 260 / 0.6), oklch(0.17 0.02 260 / 0.6)), light-dark(oklch(0.99 0.004 260 / 0.6), oklch(0.13 0.02 260 / 0.6)))",
};
