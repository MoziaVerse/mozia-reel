  ...
  return (
    <aside
      ...
      style={{
        ...
        background:
          "linear-gradient(180deg, light-dark(oklch(0.995 0.004 260 / 0.6), oklch(0.175 0.02 260 / 0.6)), light-dark(oklch(0.995 0.004 260 / 0.5), oklch(0.155 0.02 260 / 0.5)))",
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className="relative mb-px flex w-full items-center gap-2.5 rounded-md px-2 py-1.5 transition-colors focus-ring hover:bg-[light-dark(oklch(0.91_0.006_260/0.5),oklch(0.26_0.03_260/0.5))]"
              style={{
                background: active
            ...
            {!isAd && (
              <>
                ...
                <button
                  ...
                  style={{
                    background: "light-dark(oklch(0.91 0.012 260 / 0.6), oklch(0.26 0.03 260 / 0.6))",
