 ...
 * 不是一次性通知，形态取参考路线那条 warm 提示条。修复路径只有一条：把请求交给智能体，
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={handleRetry}
        className="focus-ring shrink-0 rounded border px-2.5 py-1 text-[12px] text-[var(--color-text)] hover:bg-[light-dark(oklch(0.2_0.02_260_/_0.06),oklch(1_0_0_/_0.06))]"
