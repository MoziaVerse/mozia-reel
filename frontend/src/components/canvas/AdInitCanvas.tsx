                ...
                {files.map((file, idx) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="focus-ring inline-flex h-5 w-5 shrink-0 items-center justify-center rounded transition-colors hover:bg-[light-dark(oklch(0.2_0.02_260_/_0.06),oklch(1_0_0_/_0.06))]"
