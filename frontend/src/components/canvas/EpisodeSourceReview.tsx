  ...
  return (
    <header className="flex items-start gap-3.5">
      <div
        ...
        style={{
          background: "linear-gradient(135deg, var(--color-accent) 0%, light-dark(oklch(0.675 0.2 255), oklch(0.45 0.18 255)) 100%)",
...
function GuideSection({ meta }: { meta: EpisodeMeta | undefined }) {
  ...
  return (
    <section
      ...
      style={{ background: "light-dark(oklch(0.97 0.008 260 / 0.35), oklch(0.19 0.025 260 / 0.35))", border: "1px solid var(--color-hairline)" }}
    >
      <button
        type="button"
        onClick={() => setCollapsed((v) => !v)}
        aria-expanded={!collapsed}
        className="focus-ring flex w-full items-center gap-2 px-4 py-2.5 text-left text-[11.5px] font-semibold tracking-wide transition-colors hover:bg-[light-dark(oklch(0.2_0.02_260_/_0.03),oklch(1_0_0_/_0.03))]"
        style={{
            ...
            >
              {beats.map((b, i) => (
                <div
                  ...
                  style={{ background: "light-dark(oklch(0.93 0.008 260 / 0.55), oklch(0.22 0.025 260 / 0.55))", border: "1px solid var(--color-hairline-soft)" }}
                >
      ...
      <div className="mx-auto flex min-h-0 w-full max-w-4xl flex-1 flex-col">
        ...
        <div className="mt-4 flex min-h-0 flex-1 flex-col">
          <div
            ...
            style={{
              background: "linear-gradient(180deg, light-dark(oklch(0.97 0.008 260 / 0.75), oklch(0.195 0.025 260 / 0.75)), light-dark(oklch(0.995 0.004 260 / 0.75), oklch(0.175 0.02 260 / 0.75)))",
