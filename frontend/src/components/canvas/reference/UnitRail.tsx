...
export function UnitRail({ units, selectedId, onSelect, onExpand, dirtyMap, statusMap }: UnitRailProps) {
  ...
  return (
    <div className="flex h-full min-h-0 w-[56px] flex-col overflow-hidden border-r border-[var(--color-hairline)] bg-[linear-gradient(180deg,light-dark(oklch(0.97_0.004_260_/_0.5),oklch(0.19_0.011_265_/_0.5)),light-dark(oklch(0.995_0.004_260_/_0.35),oklch(0.17_0.010_265_/_0.35)))]">
      <button
        type="button"
        onClick={onExpand}
        title={t("reference_unit_rail_expand")}
        aria-label={t("reference_unit_rail_expand")}
        className="focus-ring mx-auto mb-1.5 mt-2.5 grid h-[30px] w-[34px] place-items-center rounded border border-[var(--color-hairline-soft)] bg-[light-dark(oklch(0.93_0.004_260_/_0.5),oklch(0.22_0.011_265_/_0.5))] text-[var(--color-text-3)] hover:text-[var(--color-text)]"
      >
