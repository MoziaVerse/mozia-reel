...
export function UnitList({ units, selectedId, onSelect, onAdd, dirtyMap, statusMap }: UnitListProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden border-r border-[var(--color-hairline)] bg-[linear-gradient(180deg,light-dark(oklch(0.97_0.004_260_/_0.5),oklch(0.19_0.011_265_/_0.5)),light-dark(oklch(0.995_0.004_260_/_0.35),oklch(0.17_0.010_265_/_0.35)))]">
      <div className="flex items-center gap-2 px-3 pt-3 pb-2">
        ...
        <button
          type="button"
          onClick={onAdd}
          className="focus-ring inline-flex items-center gap-1 rounded border border-[var(--color-hairline-soft)] bg-[light-dark(oklch(0.91_0.006_260_/_0.5),oklch(0.24_0.012_265_/_0.5))] px-2 py-0.5 text-[11px] text-[var(--color-text-3)] hover:text-[var(--color-text)]"
        >
      ...
      <div className="px-3 pb-2">
        <label className="flex items-center gap-1.5 rounded-md border border-[var(--color-hairline-soft)] bg-[light-dark(oklch(0.95_0.004_260_/_0.55),oklch(0.20_0.011_265_/_0.55))] px-2 py-1.5">
            ...
            return (
              <li
                ...
                className={`focus-ring relative mb-1 cursor-pointer rounded-lg p-2.5 text-sm transition-colors ${
                  selected
                    ? "border border-[var(--color-accent-soft)] bg-[linear-gradient(180deg,light-dark(oklch(0.91_0.008_260_/_0.5),oklch(0.26_0.018_290_/_0.5)),light-dark(oklch(0.93_0.008_260_/_0.35),oklch(0.22_0.015_280_/_0.35)))]"
                    : "border border-transparent hover:bg-[light-dark(oklch(0.93_0.004_260_/_0.4),oklch(0.22_0.011_265_/_0.4))]"
                }`}
              >
                {selected && (
                  <span
                ...
                <div className="mb-1.5 flex items-center gap-1.5">
                  <span
                    className={`rounded px-1.5 py-0.5 font-mono text-[11px] font-bold tracking-wider ${
                      selected
                        ? "text-[var(--color-accent-fg)] [background:linear-gradient(180deg,var(--color-accent-2),var(--color-accent))]"
                        : "bg-[light-dark(oklch(0.93_0.004_260_/_0.6),oklch(0.22_0.011_265_/_0.6))] text-[var(--color-text-3)]"
                    }`}
                    translate="no"
                  >
                    {u.unit_id}
