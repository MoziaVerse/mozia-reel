...
export function EpisodeHeader({ episode, title, units, onSaveTitle, canEditTitle }: EpisodeHeaderProps) {
  ...
  return (
    <div className="flex flex-wrap items-end justify-between gap-5 border-b border-[var(--color-hairline)] bg-[linear-gradient(180deg,light-dark(oklch(0.93_0.006_260_/_0.4),oklch(0.22_0.014_290_/_0.4)),light-dark(oklch(0.95_0.006_260_/_0.15),oklch(0.20_0.012_250_/_0.15)))] px-6 py-4">
