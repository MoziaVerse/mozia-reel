      ...
      <div ref={setRef} className="flex min-h-0 flex-1 flex-col overflow-hidden">
        <div
          ...
          style={{
            ...
            background: "light-dark(oklch(0.97 0.004 260 / 0.3), oklch(0.18 0.02 260 / 0.3))",
          }}
        >
          {tabs.map((x) => {
      ...
      >
        <button
          ...
          style={{
            ...
            background: leftOpen ? "var(--color-accent-dim)" : "light-dark(oklch(0.95 0.008 260 / 0.5), oklch(0.2 0.025 260 / 0.5))",
