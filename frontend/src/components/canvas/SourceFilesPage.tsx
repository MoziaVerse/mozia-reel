        ...
        {loading ? (
          ...
          <button
            ...
            style={{
              ...
              background: isDragging
                ? "radial-gradient(600px 280px at 50% -10%, var(--color-accent-soft), transparent 60%), light-dark(oklch(0.97 0.004 260 / 0.45), oklch(0.18 0.02 260 / 0.45))"
          ...
          <div
            ...
            style={{
              ...
              background:
                "linear-gradient(180deg, light-dark(oklch(0.95 0.008 260 / 0.5), oklch(0.2 0.025 260 / 0.5)), light-dark(oklch(0.995 0.004 260 / 0.35), oklch(0.17 0.02 260 / 0.35)))",
              boxShadow:
            ...
            <ul>
              {files.map((file, idx) => (
                <li
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "light-dark(oklch(0.93 0.008 260 / 0.45), oklch(0.22 0.025 260 / 0.45))";
                  }}
                  onMouseLeave={(e) => {
