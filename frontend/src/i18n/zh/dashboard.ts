...
export default {
  ...
  'agent_sdk_desc': '驱动对话式 AI 智能体与自动化工作流',
  ...
  'quota_source_gift': '赠送可用',
  'quota_source_paid': '需充值',
  'quota_source_gift_hint': '赠送额度可以消耗该模型',
  'quota_source_paid_hint': '该模型只能用充值额度支付，赠送额度付不了',
