...
export default {
  ...
  'about_source_label': 'Source code of this service',
  'theme_setting': 'Theme',
  'theme_system': 'System',
  'theme_light': 'Light',
  'theme_dark': 'Dark',
  ...
  'agent_sdk_desc': 'Drives conversational AI agents and automated workflows',
  ...
  'quota_source_gift': 'Gift OK',
  'quota_source_paid': 'Paid only',
  'quota_source_gift_hint': 'Gift credits can pay for this model',
  'quota_source_paid_hint': 'This model accepts paid credits only; gift credits cannot cover it',
