...
export default {
  ...
  'about_source_label': 'Mã nguồn của dịch vụ này',
  ...
  'agent_sdk_desc': 'Vận hành tác nhân AI hội thoại và quy trình tự động',
  'agent_intro_kicker': 'Agent Runtime',
  ...
  'agent_fixed_model_desc': "Chọn mô hình mà trợ lý sử dụng. Mặc định dùng mô hình chấp nhận tín dụng tặng; GLM 5.2 mạnh hơn và chỉ trừ tín dụng trả phí.",
  'agent_model_default_tag': "Mặc định",
  ...
  'quota_source_gift': 'Dùng được quà tặng',
  'quota_source_paid': 'Chỉ trả phí',
  'quota_source_gift_hint': 'Hạn mức quà tặng có thể chi trả cho mô hình này',
  'quota_source_paid_hint': 'Mô hình này chỉ nhận hạn mức đã nạp; hạn mức quà tặng không chi trả được',
